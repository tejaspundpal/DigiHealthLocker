...
export default function PatientHeader() {
  return (
    <>
      <Disclosure as="nav" className="bg-white-800 shadow-lg sticky top-0 z-50">
        {({ open }) => (
          <>
              ...
              <div className="space-y-1 px-2 pb-3 pt-2 sm:px-3">
                {navigation.map((item) => (
                  <Disclosure.Button
                    ...
                    href={item.href}
                    className={classNames(
                      item.current ? 'bg-teal-900 text-white' : 'text-teal-300 hover:bg-teal-700 hover:text-white',
