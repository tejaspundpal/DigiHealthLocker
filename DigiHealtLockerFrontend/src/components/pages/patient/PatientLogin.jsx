      ...
      <div className="flex h-screen bg-white">
        <div className="m-auto max-w-sm w-full">
          ...
          <form className="bg-gray-100 shadow-md rounded px-8 pt-6 pb-8 mb-4">
            ...
            <div className="mb-6">
              ...
              <div className="text-right">
                <NavLink to="/forgot-password" className="text-sm text-teal-600 hover:text-teal-500 cursor-pointer">Forgot Password?</NavLink>
              </div>
            </div>
          ...
          <div className="text-center">
            <p className="text-sm">
              Don't have an account? <NavLink to="/register" className="text-teal-600 hover:text-teal-500 cursor-pointer">Register here</NavLink>
            </p>
          </div>
        </div>
      </div>
